...
**Pieces from cathelier** are always made to order: {{TO_ORDER_WEEKS}}, counted from
...
These terms are written in Portuguese. Versions in other languages are
translations; if they differ, the Portuguese version prevails.
