# Retratar-se do contrato

Se comprou como consumidor, pode desistir da compra aqui, no site, dentro dos
...
Também se pode retratar por email. Escreva para [{{EMAIL}}](mailto:{{EMAIL}})
com o seu nome, o número da encomenda (começa por IC- e está no email de
confirmação), o email que usou na compra e, se não desistir da encomenda
inteira, quais os artigos. Se o formulário não aparecer nesta página, é por aí:
um email tem o mesmo efeito. Se preferir, copie para o email o
[formulário de livre resolução]({{FORM_URL}}).
...
de receção. Veja a [privacidade](/legal/privacy/).
